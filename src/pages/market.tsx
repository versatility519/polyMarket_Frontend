    ...
    return (
        <div className="h-screen overflow-hidden-scrollbar overflow-y-auto">
            ...
            <div className="mt-36">
                ...
                {/* SubBar */}
                <div className="sticky top-[130px] bg-gray-50 drop-shadow-sm">
                    <div className="  lg:flex sm:grid-cols-2 grid-cols-2 grid lg:items-center px-4 gap-2">
                        ...
                        <div className="lg:order-2 sm:order-1 order-1 flex lg:w-full gap-5 px-4 py-1 items-center border-2 border-gray-400 hover:bg-gray-100   focus-within:border-black rounded-lg">
                            <Search color="black" />
                        ...
                        <div className="w-full lg:order-3 lg:w-[16vw] sm:w-full sm:order-4 order-4 h-full  justify-between flex items-center rounded-lg">
                            <div className="relative w-full">
                                <div className="flex  justify-between gap-2 py-2 px-2 rounded-md  cursor-pointer border items-center hover:bg-gray-100" onClick={toggleDropdown}>
                            ...
                            content.filterBtns.all.map((item, index) =>
                                <div className="">
                                    <Button key={index} value={item.value} onClick={() => handleButtonClick(`${item.value}`)} text={`${item.text}`}
                                        className={`${selectedButton === `${item.value}` ? 'bg-blue-600 text-white' : 'bg-gray-100 text-black'} flex font-medium px-2 p-1 text-nowrap  justify-center items-center text-center  gap-2 rounded-md border-2 border-gray-200 after:bg-red-500 hover:border-blue-600 focus:bg-blue-700 focus:text-white focus:border-blue-700`}
                                    />
                                </div>
                            )
                        }
