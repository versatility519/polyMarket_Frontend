    ...
    return (
        <div className=" ">
            ...
            <div className="grid grid-cols-2 gap-2  ">
                ...
                <Button onClick={() => { navigate('/markets/crypto') }} text="Crypto" className="w-full  text-xl font-medium rounded-md text-black flex gap-3 items-center outline-none border border-gray-300 px-4 py-3 text-nowrap" icon={<Droplet className="bg-purple-200 rounded-md p-1" />} />
                ...
                <Button onClick={() => { navigate('/markets/pop-culture') }} text="Pop Culture" className="w-full  text-xl font-medium rounded-md text-black flex gap-3  items-center outline-none border border-gray-300 px-4 py-3 text-nowrap" icon={<Clock3 className="bg-red-200 rounded-md p-1" />} />
                <Button onClick={() => { navigate('/markets/science') }} text="Science" className="w-full  text-xl font-medium rounded-md text-black flex gap-3 items-center outline-none border border-gray-300 px-4 py-3 text-nowrap" icon={<Clock3 className="bg-blue-200 rounded-md p-1" />} />
            </div>
            {/* </div> */}
