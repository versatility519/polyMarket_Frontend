            ...
            <div className="flex border-b">
                {data.map((item, index) => (
                    <Button
                        ...
                        className={`${selectPanel === `${item.value}` ? 'text-blue-500 border-b-2 border-blue-500  text-btnColor ' : ' text-textWhiteColor '}  flex flex-colfont-medium cursor-pointer p-2  text-nowrap`}
                    />
                ))}
            </div>
