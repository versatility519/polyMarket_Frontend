...
const EventCard: React.FC<EventProps> = ({ tid, volume, title, image, market }) => {
    ...
    const convertSpacesToHyphens = (title: string) => {
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div className="grid grid-cols-2 w-full gap-1 items-center">
                                            <Button
                                                ...
                                                text={isYesHovered == index ? `${item.outcomePrice}%` : 'Yes'}
                                            ...
                                            <Button
                                                ...
                                                text={isNoHovered == index ? `${100 - Number(item.outcomePrice)}%` : 'No'}
