...
const EventCard: React.FC<EventCardProps> = ({ img, eventName, volume, state, chance }) => {
                ...
                <div className="-z-20">
                    <div className="flex px-2 justify-between items-center">
                        ...
                        <div className="flex flex-col cursor-default text-center -z-10 ">
                            <SemiCircleProgressBar percentage={chance} strokeWidth={5} showPercentValue diameter={80} stroke={getStrokeColor(chance)} />
