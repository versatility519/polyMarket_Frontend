    ...
    return (
        <div className="md:px-2 sm:px-4 mt-4 gap-4 ">
            <div className="flex border-b-2 pb-2 items-center justify-between">
                <p className="flex items-center text-3xl font-medium text-black dark:text-white"> Activity</p>
                ...
                <select className=" bg-white  border border-gray-300 dark:bg-darkCardBg py-1 z-50 w-40 text-md rounded-md text-gray-800  px-2 font-semibold gap-1">
