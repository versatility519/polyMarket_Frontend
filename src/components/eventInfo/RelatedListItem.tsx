            ...
            <div className="w-full">
                <div className="divide-y divide-gray-200">
                    {customers.map(({ eventName, avatar, yes, no }, index) => (
                        <div
                            key={index}
                            className="flex px-1 hover:bg-gray-200 dark:hover:bg-[#2a3b49] hover:rounded-sm items-center w-full justify-between pb-3 pt-3 last:pb-0"
                        >
                            <div className="flex items-center gap-3 ">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm font-semibold dark:text-gray-400">$124,937 Bet</p>
                                </div>
                            </div>
