...
const CommentListItem = () => {
    ...
    return (
        ...
        <div className="flex flex-col gap-3">
            <div className="flex w-full justify-between items-center py-1 border border-gray-500 focus-within:border-gray-600 rounded-md">
                <input
                    type="text"
                    value={selectValue}
                    onChange={e => setSelectValue(e.target.value.trim())}
                    className="w-full p-2 bg-bgColor text-textColor focus-within:border-black dark:focus-within:border-white"
            ...
            <div className="flex bg-cardBg text-textColor items-center text-lg font-semibold gap-2 rounded-md p-4 justify-center">
                <Shield size={32} />
                    ...
                    {customers.map(({ username, address, avatar, position, volume }, index) => (
                        ...
                        >
                            <div className="w-36 items-center">
                                ...
                                >
                                    <img className='w-24 rounded-full' src={avatar} alt={avatar} onClick={() => navigate('/profile')} />
                                </Tooltip>
                            </div>
                            <div className=" ">
