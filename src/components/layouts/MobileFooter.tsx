        ...
        <div className={`fixed z-50 bottom-0 left-0 lg:hidden sm:w-full w-full border-t bg-bgColor text-gray-500 px-12 py-3 transition-transform duration-300 ${isHidden ? 'transform translate-y-full' : ''}`}>
            ...
            <div className={`fixed top-0 left-0 h-full  bg-cardBg text-textColor transition-all duration-300 ${isSidebarOpen ? 'w-[80vw]' : 'w-0 overflow-x-hidden'}`} ref={ref}>
                <div className="mx-8 mt-4" >
                    ...
                    <Button text="Leadboard" onClick={() => navigate(`/leaderboard`)} className="flex font-medium text-xl p-1  items-center" />
            ...
            <div className="flex justify-between">
                ...
                <Button icon={<Radio size={18} />} text="Activity" onClick={() => navigate(`/activity`)} className="flex flex-col p-1 hover:text-textWhiteColor  items-center text-gray-500" />

                <Button onClick={toggleSidebar} className="flex flex-col text-sm p-1 hover:text-textWhiteColor items-center text-gray-500"
