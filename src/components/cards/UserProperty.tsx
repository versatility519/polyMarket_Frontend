        ...
        <div className="flex flex-col gap-2 p-2">
            <div className="flex justify-between ">
                ...
                <div className="flex flex-col gap-2   ">
                    <p className="font-bold px-4 text-xl dark:text-white">{username}</p>
                    <p className="font-bold px-4 text-gray-500">{address}</p>
                </div>
            </div>
            <div className=" flex gap-6  ">
                <div className="flex flex-col ">
                    <p className="font-medium text-lg text-black dark:text-white">${position}</p>
                    <p className="font-medium text-gray-500">Positions</p>
                </div>
                <div className="flex flex-col ">
                    <p className="font-medium text-lg text-black dark:text-white">${volume}</p>
